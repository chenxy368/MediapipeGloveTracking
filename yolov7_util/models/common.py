...
from yolov7_util.utils.dataloaders import exif_transpose, letterbox
from yolov7_util.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from yolov7_util.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from yolov7_util.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from yolov7_util.export import export_formats
